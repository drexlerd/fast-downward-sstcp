...
std::vector<Transitions> TransitionSystem::extract_outgoing() {
    return move(outgoing);
}

std::vector<Transitions> TransitionSystem::extract_incoming() {
    return move(incoming);
}

std::vector<Loops> TransitionSystem::extract_loops() {
    return move(loops);
}
